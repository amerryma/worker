...
export interface EnhancedWithPgClient extends WithPgClient {
    ...
    withRetries: <T = void>(callback: (pgClient: PoolClient) => Promise<T>) => Promise<T>;
}
/**
...
export type CleanupTask = "GC_TASK_IDENTIFIERS" | "GC_JOB_QUEUES" | "DELETE_PERMAFAILED_JOBS";
/**
...
export interface DbJobSpec<TIdentifier extends keyof GraphileWorker.Tasks | (string & {}) = string> {
    identifier: TIdentifier;
    payload: TIdentifier extends keyof GraphileWorker.Tasks ? GraphileWorker.Tasks[TIdentifier] : unknown;
